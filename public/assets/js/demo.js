...
$(function () {
  ...
  var $themePrimary = $("<li />", {
    ...
    '<a href="javascript:void(0)" data-theme="theme-primary" style="background: #5A8DEE; display: inline-block;vertical-align: middle;" class="clearfix rounded-circle w-30 h-30" title="Theme primary">' +
      "</a>"
  );
  $skinsList.append($themePrimary);

  var $themeSecondary = $("<li />", {
    style: "padding: 5px;line-height: 25px;",
  }).append(
    '<a href="javascript:void(0)" data-theme="theme-secondary" style="background: #475F7B; display: inline-block;vertical-align: middle;" class="clearfix rounded-circle w-30 h-30" title="Theme secondary">' +
      "</a>"
  );
  ...
  var $themeInfo = $("<li />", {
    ...
    '<a href="javascript:void(0)" data-theme="theme-info" style="background: #00CFDD; display: inline-block;vertical-align: middle;" class="clearfix rounded-circle w-30 h-30" title="Theme info">' +
      "</a>"
  );
  ...
  var $themeSuccess = $("<li />", {
    ...
    '<a href="javascript:void(0)" data-theme="theme-success" style="background: #39DA8A; display: inline-block;vertical-align: middle;" class="clearfix rounded-circle w-30 h-30" title="Theme success">' +
      "</a>"
  );
  ...
  var $themeDanger = $("<li />", {
    ...
    '<a href="javascript:void(0)" data-theme="theme-danger" style="background: #FF5B5C; display: inline-block;vertical-align: middle;" class="clearfix rounded-circle w-30 h-30" title="Theme danger">' +
      "</a>"
  );
  ...
  var $themeWarning = $("<li />", {
    ...
    '<a href="javascript:void(0)" data-theme="theme-warning" style="background: #FDAC41; display: inline-block;vertical-align: middle;" class="clearfix rounded-circle w-30 h-30" title="Theme warning">' +
      "</a>"
  );
